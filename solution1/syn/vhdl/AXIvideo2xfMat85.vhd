...
architecture behav of AXIvideo2xfMat85 is 
    ...
    signal p_pyrLA1_TDATA_blk_n : STD_LOGIC;
    ...
    signal icmp_ln129_fu_299_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln132_fu_313_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal ap_phi_mux_eol_2_i_phi_fu_254_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal img_rows_blk_n : STD_LOGIC;
    signal img_cols_blk_n : STD_LOGIC;
    signal img_data_V_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp1_iter1 : STD_LOGIC := '0';
    signal icmp_ln129_reg_363 : STD_LOGIC_VECTOR (0 downto 0);
    signal eol_reg_156 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_data_V_1_i_reg_167 : STD_LOGIC_VECTOR (7 downto 0);
    signal eol_0_i_reg_178 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_0_i_reg_190 : STD_LOGIC_VECTOR (8 downto 0);
    signal axi_last_V_2_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Val2_s_reg_214 : STD_LOGIC_VECTOR (7 downto 0);
    signal img_rows_read_reg_324 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal img_cols_read_reg_329 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_data_V_reg_334 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_last_V_reg_342 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln127_fu_284_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal i_fu_289_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_reg_358 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_predicate_op61_read_state5 : BOOLEAN;
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal j_fu_304_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state8 : BOOLEAN;
    signal ap_block_pp1_stage0_subdone : BOOLEAN;
    signal ap_condition_pp1_exit_iter0_state5 : STD_LOGIC;
    signal axi_last_V_3_i_reg_227 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_last_V_0_i_reg_125 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal axi_data_V_3_i_reg_239 : STD_LOGIC_VECTOR (7 downto 0);
    signal axi_data_V_0_i_reg_135 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_0_i_reg_145 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_phi_mux_eol_phi_fu_159_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_phi_mux_eol_0_i_phi_fu_182_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_reg_pp1_iter0_p_Val2_s_reg_214 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal eol_2_i_reg_251 : STD_LOGIC_VECTOR (0 downto 0);
    signal sof_1_i_fu_84 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal zext_ln127_fu_280_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln134_fu_295_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_user_V_fu_271_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp1_exit_iter0_state5) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                    ap_enable_reg_pp1_iter0 <= ap_const_logic_0;
                elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    axi_data_V_0_i_reg_135_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                axi_data_V_0_i_reg_135 <= tmp_data_V_reg_334;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
                axi_data_V_0_i_reg_135 <= axi_data_V_3_i_reg_239;
            end if; 
        end if;
    end process;

    axi_data_V_1_i_reg_167_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                axi_data_V_1_i_reg_167 <= p_Val2_s_reg_214;
            elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                axi_data_V_1_i_reg_167 <= axi_data_V_0_i_reg_135;
            end if; 
        end if;
    end process;

    axi_data_V_3_i_reg_239_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
                axi_data_V_3_i_reg_239 <= axi_data_V_1_i_reg_167;
            elsif ((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
                axi_data_V_3_i_reg_239 <= AXI_video_strm_V_data_V_0_data_out;
            end if; 
        end if;
    end process;

    axi_last_V_0_i_reg_125_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                axi_last_V_0_i_reg_125 <= tmp_last_V_reg_342;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
                axi_last_V_0_i_reg_125 <= axi_last_V_3_i_reg_227;
            end if; 
        end if;
    end process;

    axi_last_V_2_i_reg_201_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_554)) then
                if (((or_ln132_fu_313_p2 = ap_const_lv1_1) and (icmp_ln129_fu_299_p2 = ap_const_lv1_1))) then 
                    axi_last_V_2_i_reg_201 <= ap_phi_mux_eol_phi_fu_159_p4;
                elsif (((icmp_ln129_fu_299_p2 = ap_const_lv1_1) and (or_ln132_fu_313_p2 = ap_const_lv1_0))) then 
                    axi_last_V_2_i_reg_201 <= AXI_video_strm_V_last_V_0_data_out;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    axi_last_V_2_i_reg_201 <= ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_201;
                end if;
            end if; 
        end if;
    end process;

    axi_last_V_3_i_reg_227_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
                axi_last_V_3_i_reg_227 <= eol_reg_156;
            elsif ((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
                axi_last_V_3_i_reg_227 <= AXI_video_strm_V_last_V_0_data_out;
            end if; 
        end if;
    end process;

    eol_0_i_reg_178_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                eol_0_i_reg_178 <= axi_last_V_2_i_reg_201;
            elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    eol_2_i_reg_251_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
                eol_2_i_reg_251 <= eol_0_i_reg_178;
            elsif ((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
                eol_2_i_reg_251 <= AXI_video_strm_V_last_V_0_data_out;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                eol_reg_156 <= axi_last_V_2_i_reg_201;
            elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                eol_reg_156 <= axi_last_V_0_i_reg_125;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                ...
                i_0_i_reg_145 <= i_reg_358;
            end if; 
        end if;
    end process;

    j_0_i_reg_190_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (icmp_ln129_fu_299_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                j_0_i_reg_190 <= j_fu_304_p2;
            elsif (((icmp_ln127_fu_284_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_554)) then
                if (((or_ln132_fu_313_p2 = ap_const_lv1_1) and (icmp_ln129_fu_299_p2 = ap_const_lv1_1))) then 
                    p_Val2_s_reg_214 <= ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4;
                elsif (((icmp_ln129_fu_299_p2 = ap_const_lv1_1) and (or_ln132_fu_313_p2 = ap_const_lv1_0))) then 
                    p_Val2_s_reg_214 <= AXI_video_strm_V_data_V_0_data_out;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    p_Val2_s_reg_214 <= ap_phi_reg_pp1_iter0_p_Val2_s_reg_214;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_load_A)) then
                AXI_video_strm_V_data_V_0_payload_A <= p_pyrLA1_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_load_B)) then
                AXI_video_strm_V_data_V_0_payload_B <= p_pyrLA1_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_last_V_0_load_A)) then
                AXI_video_strm_V_last_V_0_payload_A <= p_pyrLA1_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_last_V_0_load_B)) then
                AXI_video_strm_V_last_V_0_payload_B <= p_pyrLA1_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_user_V_0_load_A)) then
                AXI_video_strm_V_user_V_0_payload_A <= p_pyrLA1_TUSER;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = AXI_video_strm_V_user_V_0_load_B)) then
                AXI_video_strm_V_user_V_0_payload_B <= p_pyrLA1_TUSER;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then
                icmp_ln129_reg_363 <= icmp_ln129_fu_299_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((img_cols_empty_n = ap_const_logic_0) or (img_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                img_cols_read_reg_329 <= img_cols_dout;
                img_rows_read_reg_324 <= img_rows_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                tmp_data_V_reg_334 <= AXI_video_strm_V_data_V_0_data_out;
                tmp_last_V_reg_342 <= AXI_video_strm_V_last_V_0_data_out;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, AXI_video_strm_V_data_V_0_vld_out, img_rows_empty_n, img_cols_empty_n, ap_CS_fsm_state2, ap_enable_reg_pp1_iter0, icmp_ln129_fu_299_p2, ap_CS_fsm_state8, ap_phi_mux_eol_2_i_phi_fu_254_p4, icmp_ln127_fu_284_p2, ap_CS_fsm_state4, ap_block_pp1_stage0_subdone, eol_2_i_reg_251, tmp_user_V_fu_271_p1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((tmp_user_V_fu_271_p1 = ap_const_lv1_0) and (ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif (((tmp_user_V_fu_271_p1 = ap_const_lv1_1) and (ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((icmp_ln127_fu_284_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                end if;
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (icmp_ln129_fu_299_p2 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (icmp_ln129_fu_299_p2 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state8 => 
                if ((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                elsif ((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (ap_phi_mux_eol_2_i_phi_fu_254_p4 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
    ...
    AXI_video_strm_V_data_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_CS_fsm_state8, ap_predicate_op61_read_state5, ap_block_pp1_stage0_11001, eol_2_i_reg_251)
    begin
        if (((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)) or ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    AXI_video_strm_V_data_V_0_vld_in <= p_pyrLA1_TVALID;
    AXI_video_strm_V_data_V_0_vld_out <= AXI_video_strm_V_data_V_0_state(0);

    AXI_video_strm_V_dest_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_CS_fsm_state8, ap_predicate_op61_read_state5, ap_block_pp1_stage0_11001, eol_2_i_reg_251)
    begin
        if (((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)) or ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    AXI_video_strm_V_dest_V_0_vld_in <= p_pyrLA1_TVALID;
    AXI_video_strm_V_last_V_0_ack_in <= AXI_video_strm_V_last_V_0_state(1);

    AXI_video_strm_V_last_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_CS_fsm_state8, ap_predicate_op61_read_state5, ap_block_pp1_stage0_11001, eol_2_i_reg_251)
    begin
        if (((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)) or ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    AXI_video_strm_V_last_V_0_vld_in <= p_pyrLA1_TVALID;
    ...
    AXI_video_strm_V_user_V_0_ack_out_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_CS_fsm_state8, ap_predicate_op61_read_state5, ap_block_pp1_stage0_11001, eol_2_i_reg_251)
    begin
        if (((not(((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out))) and (eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)) or ((ap_const_logic_1 = AXI_video_strm_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    AXI_video_strm_V_user_V_0_vld_in <= p_pyrLA1_TVALID;
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, img_data_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, ap_predicate_op61_read_state5)
    begin
                ap_block_pp1_stage0_01001 <= (((icmp_ln129_reg_363 = ap_const_lv1_1) and (img_data_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)) or ((ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, img_data_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, ap_predicate_op61_read_state5)
    begin
                ap_block_pp1_stage0_11001 <= (((icmp_ln129_reg_363 = ap_const_lv1_1) and (img_data_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)) or ((ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, img_data_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, ap_predicate_op61_read_state5)
    begin
                ap_block_pp1_stage0_subdone <= (((icmp_ln129_reg_363 = ap_const_lv1_1) and (img_data_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)) or ((ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out) and (ap_predicate_op61_read_state5 = ap_const_boolean_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)));
    end process;
    ...
    ap_block_state5_pp1_stage0_iter0_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, ap_predicate_op61_read_state5)
    begin
                ap_block_state5_pp1_stage0_iter0 <= ((ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out) and (ap_predicate_op61_read_state5 = ap_const_boolean_1));
    end process;


    ap_block_state6_pp1_stage0_iter1_assign_proc : process(img_data_V_full_n, icmp_ln129_reg_363)
    begin
                ap_block_state6_pp1_stage0_iter1 <= ((icmp_ln129_reg_363 = ap_const_lv1_1) and (img_data_V_full_n = ap_const_logic_0));
    end process;


    ap_block_state8_assign_proc : process(AXI_video_strm_V_data_V_0_vld_out, eol_2_i_reg_251)
    begin
                ap_block_state8 <= ((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = AXI_video_strm_V_data_V_0_vld_out));
    end process;


    ap_condition_554_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_block_pp1_stage0_11001)
    begin
                ap_condition_554 <= ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0));
    end process;


    ap_condition_pp1_exit_iter0_state5_assign_proc : process(icmp_ln129_fu_299_p2)
    begin
        if ((icmp_ln129_fu_299_p2 = ap_const_lv1_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, icmp_ln127_fu_284_p2, ap_CS_fsm_state4)
    begin
        if (((icmp_ln127_fu_284_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, axi_data_V_1_i_reg_167, p_Val2_s_reg_214)
    begin
        if (((icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4 <= p_Val2_s_reg_214;
        else 
            ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4 <= axi_data_V_1_i_reg_167;
        end if; 
    end process;


    ap_phi_mux_eol_0_i_phi_fu_182_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, eol_0_i_reg_178, axi_last_V_2_i_reg_201)
    begin
        if (((icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            ap_phi_mux_eol_0_i_phi_fu_182_p4 <= axi_last_V_2_i_reg_201;
        else 
            ap_phi_mux_eol_0_i_phi_fu_182_p4 <= eol_0_i_reg_178;
        end if; 
    end process;

    ap_phi_mux_eol_2_i_phi_fu_254_p4 <= eol_2_i_reg_251;

    ap_phi_mux_eol_phi_fu_159_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, eol_reg_156, axi_last_V_2_i_reg_201)
    begin
        if (((icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            ap_phi_mux_eol_phi_fu_159_p4 <= axi_last_V_2_i_reg_201;
        else 
            ap_phi_mux_eol_phi_fu_159_p4 <= eol_reg_156;
        end if; 
    end process;

    ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_201 <= "X";
    ap_phi_reg_pp1_iter0_p_Val2_s_reg_214 <= "XXXXXXXX";

    ap_predicate_op61_read_state5_assign_proc : process(icmp_ln129_fu_299_p2, or_ln132_fu_313_p2)
    begin
                ap_predicate_op61_read_state5 <= ((icmp_ln129_fu_299_p2 = ap_const_lv1_1) and (or_ln132_fu_313_p2 = ap_const_lv1_0));
    end process;


    ap_ready_assign_proc : process(icmp_ln127_fu_284_p2, ap_CS_fsm_state4)
    begin
        if (((icmp_ln127_fu_284_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    i_fu_289_p2 <= std_logic_vector(unsigned(i_0_i_reg_145) + unsigned(ap_const_lv8_1));
    icmp_ln127_fu_284_p2 <= "1" when (signed(zext_ln127_fu_280_p1) < signed(img_rows_read_reg_324)) else "0";
    icmp_ln129_fu_299_p2 <= "1" when (signed(zext_ln134_fu_295_p1) < signed(img_cols_read_reg_329)) else "0";
    ...
    img_data_V_blk_n_assign_proc : process(img_data_V_full_n, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363)
    begin
        if (((icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    img_data_V_din <= p_Val2_s_reg_214;

    img_data_V_write_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln129_reg_363, ap_block_pp1_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (icmp_ln129_reg_363 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    j_fu_304_p2 <= std_logic_vector(unsigned(j_0_i_reg_190) + unsigned(ap_const_lv9_1));
    or_ln132_fu_313_p2 <= (sof_1_i_fu_84 or ap_phi_mux_eol_0_i_phi_fu_182_p4);

    p_pyrLA1_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_0_state, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_block_pp1_stage0, icmp_ln129_fu_299_p2, or_ln132_fu_313_p2, ap_CS_fsm_state8, eol_2_i_reg_251)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((eol_2_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)) or ((icmp_ln129_fu_299_p2 = ap_const_lv1_1) and (or_ln132_fu_313_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)))) then 
            p_pyrLA1_TDATA_blk_n <= AXI_video_strm_V_data_V_0_state(0);
        else 
            p_pyrLA1_TDATA_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    p_pyrLA1_TREADY <= AXI_video_strm_V_dest_V_0_state(1);
    tmp_user_V_fu_271_p1 <= AXI_video_strm_V_user_V_0_data_out;
    zext_ln127_fu_280_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_i_reg_145),9));
    zext_ln134_fu_295_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_i_reg_190),10));
end behav;
