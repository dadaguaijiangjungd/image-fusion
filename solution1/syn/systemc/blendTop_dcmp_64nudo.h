...
// ==============================================================
#ifndef __blendTop_dcmp_64nudo__HH__
#define __blendTop_dcmp_64nudo__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_dcmp_64nudo) {
    ...
    SC_CTOR(blendTop_dcmp_64nudo):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
