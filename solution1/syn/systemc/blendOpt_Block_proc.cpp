...
const sc_logic blendOpt_Block_proc::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic blendOpt_Block_proc::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<1> blendOpt_Block_proc::ap_ST_fsm_state1 = "1";
const sc_lv<32> blendOpt_Block_proc::ap_const_lv32_0 = "00000000000000000000000000000000";
const bool blendOpt_Block_proc::ap_const_boolean_1 = true;

blendOpt_Block_proc::blendOpt_Block_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "blendOpt_Block_proc_sc_trace_" << apTFileNum ++;
...
blendOpt_Block_proc::~blendOpt_Block_proc() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void blendOpt_Block_proc::thread_ap_clk_no_reset_() {
...
void blendOpt_Block_proc::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void blendOpt_Block_proc::thread_ap_block_state1() {
...
void blendOpt_Block_proc::thread_ap_done() {
...
void blendOpt_Block_proc::thread_ap_idle() {
...
void blendOpt_Block_proc::thread_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_load3_out_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_load4_out_out_full_n.read())))) {
...
void blendOpt_Block_proc::thread_imageA_cols_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void blendOpt_Block_proc::thread_imageA_cols_load4_out_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void blendOpt_Block_proc::thread_imageA_cols_load4_out_out_din() {
    imageA_cols_load4_out_out_din = imageA_cols_dout.read();
}

void blendOpt_Block_proc::thread_imageA_cols_load4_out_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_load3_out_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_load4_out_out_full_n.read())))) {
...
void blendOpt_Block_proc::thread_imageA_cols_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_load3_out_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_load4_out_out_full_n.read())))) {
...
void blendOpt_Block_proc::thread_imageA_rows_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void blendOpt_Block_proc::thread_imageA_rows_load3_out_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void blendOpt_Block_proc::thread_imageA_rows_load3_out_out_din() {
    imageA_rows_load3_out_out_din = imageA_rows_dout.read();
}

void blendOpt_Block_proc::thread_imageA_rows_load3_out_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_load3_out_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_load4_out_out_full_n.read())))) {
...
void blendOpt_Block_proc::thread_imageA_rows_read() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_rows_load3_out_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, imageA_cols_load4_out_out_full_n.read())))) {
...
void blendOpt_Block_proc::thread_ap_NS_fsm() {
