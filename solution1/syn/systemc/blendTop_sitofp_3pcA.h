...
// ==============================================================
#ifndef __blendTop_sitofp_3pcA__HH__
#define __blendTop_sitofp_3pcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_sitofp_3pcA) {
    ...
    SC_CTOR(blendTop_sitofp_3pcA):  ACMP_sitofp_U ("ACMP_sitofp_U") {
