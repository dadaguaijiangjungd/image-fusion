...
// ==============================================================
#ifndef __blendTop_uitofp_6ocq__HH__
#define __blendTop_uitofp_6ocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_uitofp_6ocq) {
    ...
    SC_CTOR(blendTop_uitofp_6ocq):  ACMP_uitofp_U ("ACMP_uitofp_U") {
