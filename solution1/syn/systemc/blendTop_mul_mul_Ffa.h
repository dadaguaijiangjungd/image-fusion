...
// ==============================================================
#ifndef __blendTop_mul_mul_Ffa__HH__
#define __blendTop_mul_mul_Ffa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mul_mul_Ffa) {
    ...
    SC_CTOR(blendTop_mul_mul_Ffa):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
