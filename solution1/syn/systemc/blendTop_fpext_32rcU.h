...
// ==============================================================
#ifndef __blendTop_fpext_32rcU__HH__
#define __blendTop_fpext_32rcU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_fpext_32rcU) {
    ...
    SC_CTOR(blendTop_fpext_32rcU):  ACMP_fpext_U ("ACMP_fpext_U") {
