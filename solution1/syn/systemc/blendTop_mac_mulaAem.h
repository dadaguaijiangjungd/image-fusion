...
// ==============================================================
#ifndef __blendTop_mac_mulaAem__HH__
#define __blendTop_mac_mulaAem__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mac_mulaAem) {
    ...
    SC_CTOR(blendTop_mac_mulaAem):  simcore_mac_2_U ("simcore_mac_2_U") {
