...
// ==============================================================
#ifndef __blendTop_mac_mulaCeG__HH__
#define __blendTop_mac_mulaCeG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mac_mulaCeG) {
    ...
    SC_CTOR(blendTop_mac_mulaCeG):  simcore_mac_4_U ("simcore_mac_4_U") {
