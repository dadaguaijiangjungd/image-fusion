...
// ==============================================================
#ifndef __blendTop_mul_mul_bkb__HH__
#define __blendTop_mul_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mul_mul_bkb) {
    ...
    SC_CTOR(blendTop_mul_mul_bkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
