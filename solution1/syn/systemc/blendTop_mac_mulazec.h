...
// ==============================================================
#ifndef __blendTop_mac_mulazec__HH__
#define __blendTop_mac_mulazec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mac_mulazec) {
    ...
    SC_CTOR(blendTop_mac_mulazec):  simcore_mac_1_U ("simcore_mac_1_U") {
