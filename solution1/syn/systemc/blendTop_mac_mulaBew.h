...
// ==============================================================
#ifndef __blendTop_mac_mulaBew__HH__
#define __blendTop_mac_mulaBew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mac_mulaBew) {
    ...
    SC_CTOR(blendTop_mac_mulaBew):  simcore_mac_3_U ("simcore_mac_3_U") {
