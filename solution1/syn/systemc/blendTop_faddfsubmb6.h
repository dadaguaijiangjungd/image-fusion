...
// ==============================================================
#ifndef __blendTop_faddfsubmb6__HH__
#define __blendTop_faddfsubmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_faddfsubmb6) {
    ...
    SC_CTOR(blendTop_faddfsubmb6):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
