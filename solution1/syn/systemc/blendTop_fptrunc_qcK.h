...
// ==============================================================
#ifndef __blendTop_fptrunc_qcK__HH__
#define __blendTop_fptrunc_qcK__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_fptrunc_qcK) {
    ...
    SC_CTOR(blendTop_fptrunc_qcK):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
