...
// ==============================================================
#ifndef __blendTop_mac_mulayd2__HH__
#define __blendTop_mac_mulayd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(blendTop_mac_mulayd2) {
    ...
    SC_CTOR(blendTop_mac_mulayd2):  simcore_mac_0_U ("simcore_mac_0_U") {
