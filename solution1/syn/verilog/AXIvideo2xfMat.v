...
wire   [8:0] trunc_ln129_fu_303_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_256 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((or_ln132_fu_316_p2 == 1'd0) & (icmp_ln129_fu_307_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        p_pyrLB1_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
        p_pyrLB1_TDATA_blk_n = 1'b1;
    end
end
...
assign AXI_video_strm_V_data_V_0_vld_in = p_pyrLB1_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = p_pyrLB1_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = p_pyrLB1_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = p_pyrLB1_TVALID;

assign AXI_video_strm_V_user_V_0_vld_out = AXI_video_strm_V_user_V_0_state[1'd0];

assign add_ln127_fu_333_p2 = ($signed(indvars_iv_reg_107) + $signed(9'd320));

assign add_ln151_fu_322_p2 = (val_assign_reg_184 + 17'd1);
...
assign i_fu_291_p2 = (i_0_reg_151 + 8'd1);

assign icmp_ln127_fu_285_p2 = ((i_0_reg_151 == 8'd240) ? 1'b1 : 1'b0);
...
assign p_pyrLB1_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign tmp_user_V_fu_276_p1 = AXI_video_strm_V_user_V_0_data_out;

assign trunc_ln129_fu_303_p1 = val_assign_reg_184[8:0];

assign val_fu_297_p2 = (val_0_reg_139 + 17'd320);
