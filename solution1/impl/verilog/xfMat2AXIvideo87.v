...
reg   [0:0] icmp_ln187_reg_265;
reg    p_pyrS0_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln187_reg_265_pp0_iter1_reg;
reg   [18:0] index_assign_reg_157;
reg   [9:0] j_0_reg_167;
wire   [0:0] icmp_ln186_fu_183_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [8:0] i_fu_189_p2;
reg   [8:0] i_reg_255;
wire   [18:0] index_fu_195_p2;
reg   [18:0] index_reg_260;
wire   [0:0] icmp_ln187_fu_205_p2;
...
wire   [9:0] j_fu_211_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_217_p2;
reg   [0:0] axi_last_V_reg_274;
wire   [18:0] add_ln203_fu_223_p2;
wire   [9:0] add_ln186_fu_238_p2;
wire    ap_CS_fsm_state6;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [9:0] indvars_iv_reg_122;
reg    ap_block_state1;
reg   [18:0] index_0_reg_134;
reg   [8:0] i_0_reg_146;
reg   [0:0] tmp_user_V_fu_82;
reg    ap_block_pp0_stage0_01001;
wire   [9:0] trunc_ln187_fu_201_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)))) begin
            AXI_video_strm_V_data_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_data_V_1_vld_in) & (1'b1 == AXI_video_strm_V_data_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_data_V_1_state)) | ((2'd1 == AXI_video_strm_V_data_V_1_state) & (1'b1 == AXI_video_strm_V_data_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_data_V_1_state) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)))) begin
            AXI_video_strm_V_dest_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_dest_V_1_vld_in) & (1'b1 == AXI_video_strm_V_dest_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_dest_V_1_state)) | ((2'd1 == AXI_video_strm_V_dest_V_1_state) & (1'b1 == AXI_video_strm_V_dest_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_dest_V_1_state) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)))) begin
            AXI_video_strm_V_id_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_id_V_1_vld_in) & (1'b1 == AXI_video_strm_V_id_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_id_V_1_state)) | ((2'd1 == AXI_video_strm_V_id_V_1_state) & (1'b1 == AXI_video_strm_V_id_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_id_V_1_state) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)))) begin
            AXI_video_strm_V_keep_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_keep_V_1_vld_in) & (1'b1 == AXI_video_strm_V_keep_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_keep_V_1_state)) | ((2'd1 == AXI_video_strm_V_keep_V_1_state) & (1'b1 == AXI_video_strm_V_keep_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_keep_V_1_state) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)))) begin
            AXI_video_strm_V_last_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_last_V_1_vld_in) & (1'b1 == AXI_video_strm_V_last_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_last_V_1_state)) | ((2'd1 == AXI_video_strm_V_last_V_1_state) & (1'b1 == AXI_video_strm_V_last_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_last_V_1_state) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)))) begin
            AXI_video_strm_V_strb_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_strb_V_1_vld_in) & (1'b1 == AXI_video_strm_V_strb_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_strb_V_1_state)) | ((2'd1 == AXI_video_strm_V_strb_V_1_state) & (1'b1 == AXI_video_strm_V_strb_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_strb_V_1_state) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)))) begin
            AXI_video_strm_V_user_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_user_V_1_vld_in) & (1'b1 == AXI_video_strm_V_user_V_1_ack_out)) & ~((p_pyrS0_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_user_V_1_state)) | ((2'd1 == AXI_video_strm_V_user_V_1_state) & (1'b1 == AXI_video_strm_V_user_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_user_V_1_state) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0))) & (icmp_ln186_fu_183_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0))) & (icmp_ln186_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln187_fu_205_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln187_reg_265 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_user_V_fu_82 <= 1'd0;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_82 <= 1'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln187_fu_205_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        axi_last_V_reg_274 <= axi_last_V_fu_217_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((icmp_ln187_fu_205_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln187_reg_265 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln187_reg_265_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln187_reg_265 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        p_pyrS0_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
        p_pyrS0_TDATA_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln187_fu_205_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln187_fu_205_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign AXI_video_strm_V_data_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = p_pyrS0_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = p_pyrS0_TREADY;
...
assign add_ln186_fu_238_p2 = ($signed(indvars_iv_reg_122) + $signed(10'd640));

assign add_ln203_fu_223_p2 = (index_assign_reg_157 + 19'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln187_reg_265 == 1'd0) & (img_data_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln187_reg_265 == 1'd0) & (img_data_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln187_reg_265 == 1'd0) & (img_data_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2 = ((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (p_pyrS0_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (p_pyrS0_TREADY == 1'b0)));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((icmp_ln187_reg_265 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln187_reg_265 == 1'd0) & (img_data_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln187_reg_265_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_217_p2 = ((j_0_reg_167 == 10'd639) ? 1'b1 : 1'b0);

assign i_fu_189_p2 = (i_0_reg_146 + 9'd1);

assign icmp_ln186_fu_183_p2 = ((i_0_reg_146 == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln187_fu_205_p2 = ((trunc_ln187_fu_201_p1 == indvars_iv_reg_122) ? 1'b1 : 1'b0);

assign index_fu_195_p2 = (index_0_reg_134 + 19'd640);

assign j_fu_211_p2 = (10'd1 + j_0_reg_167);

assign p_pyrS0_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign p_pyrS0_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign p_pyrS0_TID = AXI_video_strm_V_id_V_1_data_out;

assign p_pyrS0_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign p_pyrS0_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign p_pyrS0_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign p_pyrS0_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign p_pyrS0_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];

assign trunc_ln187_fu_201_p1 = index_assign_reg_157[9:0];

endmodule //xfMat2AXIvideo87
