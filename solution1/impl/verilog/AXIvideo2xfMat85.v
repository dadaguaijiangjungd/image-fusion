...
input  [8:0] img_rows_dout;
input   img_rows_empty_n;
output   img_rows_read;
input  [9:0] img_cols_dout;
...
reg    p_pyrLA1_TDATA_blk_n;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_pp1_stage0;
reg    ap_enable_reg_pp1_iter0;
wire    ap_block_pp1_stage0;
wire   [0:0] icmp_ln129_fu_299_p2;
wire   [0:0] or_ln132_fu_313_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_eol_2_i_phi_fu_254_p4;
reg    img_rows_blk_n;
reg    img_cols_blk_n;
reg    img_data_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] icmp_ln129_reg_363;
reg   [0:0] eol_reg_156;
reg   [7:0] axi_data_V_1_i_reg_167;
reg   [0:0] eol_0_i_reg_178;
reg   [8:0] j_0_i_reg_190;
reg   [0:0] axi_last_V_2_i_reg_201;
reg   [7:0] p_Val2_s_reg_214;
reg   [8:0] img_rows_read_reg_324;
reg    ap_block_state1;
reg   [9:0] img_cols_read_reg_329;
reg   [7:0] tmp_data_V_reg_334;
reg   [0:0] tmp_last_V_reg_342;
wire   [0:0] icmp_ln127_fu_284_p2;
...
wire   [8:0] j_fu_304_p2;
reg    ap_block_state8;
reg    ap_block_pp1_stage0_subdone;
reg    ap_condition_pp1_exit_iter0_state5;
reg   [0:0] axi_last_V_3_i_reg_227;
reg   [0:0] axi_last_V_0_i_reg_125;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state3;
reg   [7:0] axi_data_V_3_i_reg_239;
reg   [7:0] axi_data_V_0_i_reg_135;
reg   [7:0] i_0_i_reg_145;
reg   [0:0] ap_phi_mux_eol_phi_fu_159_p4;
reg   [7:0] ap_phi_mux_axi_data_V_1_i_phi_fu_170_p4;
reg   [0:0] ap_phi_mux_eol_0_i_phi_fu_182_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_201;
wire   [7:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_214;
wire    ap_CS_fsm_state7;
reg   [0:0] eol_2_i_reg_251;
reg   [0:0] sof_1_i_fu_84;
reg    ap_block_pp1_stage0_01001;
wire   [8:0] zext_ln127_fu_280_p1;
wire   [9:0] zext_ln134_fu_295_p1;
wire   [0:0] tmp_user_V_fu_271_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln127_fu_284_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((icmp_ln127_fu_284_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln129_reg_363 == 1'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_i_reg_251 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_554)) begin
        if (((or_ln132_fu_313_p2 == 1'd1) & (icmp_ln129_fu_299_p2 == 1'd1))) begin
            axi_last_V_2_i_reg_201 <= ap_phi_mux_eol_phi_fu_159_p4;
        end else if (((icmp_ln129_fu_299_p2 == 1'd1) & (or_ln132_fu_313_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln129_fu_299_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((img_cols_empty_n == 1'b0) | (img_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((~((eol_2_i_reg_251 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op61_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((icmp_ln129_fu_299_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln127_fu_284_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln129_reg_363 == 1'd1) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((icmp_ln129_fu_299_p2 == 1'd1) & (or_ln132_fu_313_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        p_pyrLA1_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
        p_pyrLA1_TDATA_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_271_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_271_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln129_fu_299_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (icmp_ln129_fu_299_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((eol_2_i_reg_251 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((eol_2_i_reg_251 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (ap_phi_mux_eol_2_i_phi_fu_254_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
assign AXI_video_strm_V_data_V_0_vld_in = p_pyrLA1_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = p_pyrLA1_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = p_pyrLA1_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = p_pyrLA1_TVALID;
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((icmp_ln129_reg_363 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op61_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((icmp_ln129_reg_363 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op61_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((icmp_ln129_reg_363 == 1'd1) & (img_data_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op61_read_state5 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state1 = ((img_cols_empty_n == 1'b0) | (img_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state5_pp1_stage0_iter0 = ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op61_read_state5 == 1'b1));
end

always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln129_reg_363 == 1'd1) & (img_data_V_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((eol_2_i_reg_251 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end
...
assign ap_phi_mux_eol_2_i_phi_fu_254_p4 = eol_2_i_reg_251;

assign ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_201 = 'bx;

assign ap_phi_reg_pp1_iter0_p_Val2_s_reg_214 = 'bx;

always @ (*) begin
    ap_predicate_op61_read_state5 = ((icmp_ln129_fu_299_p2 == 1'd1) & (or_ln132_fu_313_p2 == 1'd0));
end

assign i_fu_289_p2 = (i_0_i_reg_145 + 8'd1);

assign icmp_ln127_fu_284_p2 = (($signed(zext_ln127_fu_280_p1) < $signed(img_rows_read_reg_324)) ? 1'b1 : 1'b0);

assign icmp_ln129_fu_299_p2 = (($signed(zext_ln134_fu_295_p1) < $signed(img_cols_read_reg_329)) ? 1'b1 : 1'b0);

assign img_data_V_din = p_Val2_s_reg_214;

assign j_fu_304_p2 = (j_0_i_reg_190 + 9'd1);

assign or_ln132_fu_313_p2 = (sof_1_i_fu_84 | ap_phi_mux_eol_0_i_phi_fu_182_p4);

assign p_pyrLA1_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign tmp_user_V_fu_271_p1 = AXI_video_strm_V_user_V_0_data_out;

assign zext_ln127_fu_280_p1 = i_0_i_reg_145;

assign zext_ln134_fu_295_p1 = j_0_i_reg_190;

endmodule //AXIvideo2xfMat85
