set moduleName AXIvideo2xfMat84
set isTopModule 0
...
set C_modelName {AXIvideo2xfMat84}
set C_modelType { void 0 }
set C_modelArgList {
	{ AXI_video_strm_V_data_V int 8 regular {axi_s 0 volatile  { p_pyrLA0 Data } }  }
	{ AXI_video_strm_V_keep_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 Keep } }  }
	{ AXI_video_strm_V_strb_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 0 volatile  { p_pyrLA0 Dest } }  }
	{ img_rows int 10 regular {fifo 0}  }
	{ img_cols int 11 regular {fifo 0}  }
	{ img_data_V int 8 regular {fifo 1 volatile }  }
	{ img_rows_out int 10 regular {fifo 1}  }
	{ img_cols_out int 11 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "AXI_video_strm_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "img_rows", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "img_cols", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "img_data_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "img_rows_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	{ "Name" : "img_cols_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_pyrLA0_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "p_pyrLA0_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "img_rows_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "img_rows", "role": "dout" }} , 
 	...
 	{ "name": "img_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "img_cols", "role": "dout" }} , 
 	...
 	{ "name": "img_rows_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "img_rows_out", "role": "din" }} , 
 	...
 	{ "name": "img_cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "img_cols_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { p_pyrLA0_TDATA in_data 0 8 } } }
	AXI_video_strm_V_keep_V { axis {  { p_pyrLA0_TKEEP in_data 0 1 } } }
	AXI_video_strm_V_strb_V { axis {  { p_pyrLA0_TSTRB in_data 0 1 } } }
	AXI_video_strm_V_user_V { axis {  { p_pyrLA0_TUSER in_data 0 1 } } }
	AXI_video_strm_V_last_V { axis {  { p_pyrLA0_TLAST in_data 0 1 } } }
	AXI_video_strm_V_id_V { axis {  { p_pyrLA0_TID in_data 0 1 } } }
	AXI_video_strm_V_dest_V { axis {  { p_pyrLA0_TVALID in_vld 0 1 }  { p_pyrLA0_TREADY in_acc 1 1 }  { p_pyrLA0_TDEST in_data 0 1 } } }
	img_rows { ap_fifo {  { img_rows_dout fifo_data 0 10 }  { img_rows_empty_n fifo_status 0 1 }  { img_rows_read fifo_update 1 1 } } }
	img_cols { ap_fifo {  { img_cols_dout fifo_data 0 11 }  { img_cols_empty_n fifo_status 0 1 }  { img_cols_read fifo_update 1 1 } } }
	img_data_V { ap_fifo {  { img_data_V_din fifo_data 1 8 }  { img_data_V_full_n fifo_status 0 1 }  { img_data_V_write fifo_update 1 1 } } }
	img_rows_out { ap_fifo {  { img_rows_out_din fifo_data 1 10 }  { img_rows_out_full_n fifo_status 0 1 }  { img_rows_out_write fifo_update 1 1 } } }
	img_cols_out { ap_fifo {  { img_cols_out_din fifo_data 1 11 }  { img_cols_out_full_n fifo_status 0 1 }  { img_cols_out_write fifo_update 1 1 } } }
}
