...
set structArgument5 [list 8 1 1 1 ]
set NameSpace5 [list ]
set structIsPacked5 "1"
set DataType5 [list "ap_axiu<8, 1, 1, 1>" "struct ap_axiu" $structMem5 1 0 $structParameter5 $structArgument5 $NameSpace5 $structIsPacked5]
