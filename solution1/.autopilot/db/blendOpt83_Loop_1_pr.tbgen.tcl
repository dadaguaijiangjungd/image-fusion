set moduleName blendOpt83_Loop_1_pr
set isTopModule 0
...
set C_modelName {blendOpt83_Loop_1_pr}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "imageB_data_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "tmp_V_11_read_r_fu_124", "Port" : "Mat_0_480_640_1_data_V_addr"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_V_11_read_r_fu_124", "Parent" : "0",
		"CDFG" : "read_r",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "Mat_0_480_640_1_data_V_addr", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "Mat_0_480_640_1_data_V_addr_blk_n", "Type" : "RtlPort"}]}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.blendTop_mul_mul_bkb_U58", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "307203"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "307203"}
]}
