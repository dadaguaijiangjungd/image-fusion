...
set out_width 19
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 0 +} m {16 0 +} i2 {18 0 +} p {19 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 20
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 0 +} m {16 0 +} i2 {19 0 +} p {20 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 21
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 0 +} m {16 0 +} i2 {20 0 +} p {21 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 168
set hasByteEnable 0
set MemName xf_pyrdown_gaussicud
...
eval "cg_default_interface_gen_dc { \
    id 169 \
    name p_src_mat_A_V_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_p_src_mat_A_V_V \
    op interface \
    ports { p_src_mat_A_V_V_dout { I 8 vector } p_src_mat_A_V_V_empty_n { I 1 bit } p_src_mat_A_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 170 \
    name p_src_mat_B_V_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_p_src_mat_B_V_V \
    op interface \
    ports { p_src_mat_B_V_V_dout { I 8 vector } p_src_mat_B_V_V_empty_n { I 1 bit } p_src_mat_B_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_out_mat_V_V_din { O 8 vector } p_out_mat_V_V_full_n { I 1 bit } p_out_mat_V_V_write { O 1 bit } } \
} "
}
